...
test.describe("Performance — LCP Budgets", () => {
  ...
  test("dashboard LCP is under 2500ms @regression", async ({
    authenticatedPage,
  }) => {
  ...
  test("prices page LCP is under 2500ms @regression", async ({
    authenticatedPage,
  }) => {
    ...
    await authenticatedPage.waitForSelector("body");
    await authenticatedPage.waitForSelector('h1, [role="heading"]', {
      timeout: 10000,
    });
  ...
  test("suppliers page LCP is under 2500ms @regression", async ({
    authenticatedPage,
  }) => {
...
test.describe("Performance — CLS Budgets", () => {
  ...
  test("dashboard CLS is under 0.1 @regression", async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto("/dashboard", {
      waitUntil: "domcontentloaded",
    ...
    // Wait for main content to render before measuring CLS so the
    // skeleton→content transition is captured in the observation window
    await expect(
  ...
  test("prices page CLS is under 0.1 @regression", async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto("/prices", {
      waitUntil: "domcontentloaded",
  ...
  test("suppliers page CLS is under 0.1 @regression", async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto("/suppliers", {
      waitUntil: "domcontentloaded",
  ...
  test("optimize page CLS is under 0.1 @regression", async ({
    authenticatedPage,
  }) => {
  ...
  test("settings page CLS is under 0.1 @regression", async ({
    authenticatedPage,
  }) => {
...
test.describe("Performance — SPA Navigation Speed", () => {
  ...
  test.skip(
    ({ isMobile }) => isMobile,
    "Sidebar navigation is hidden on mobile",
  );
