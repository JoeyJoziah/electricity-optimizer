...
test.describe("Visual Regression", { tag: ["@regression"] }, () => {
  ...
  test.describe("Landing Page", () => {
    ...
    test("desktop light mode", async ({ page }) => {
      ...
      // Wait for main content to render before taking screenshot
  ...
  test.describe("Dashboard", () => {
    test("default state", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage).toHaveScreenshot("dashboard-default.png");
    });
    ...
    test.describe("Pro tier", () => {
      ...
      test("with Pro settings", async ({ authenticatedPage }) => {
        ...
        await expect(authenticatedPage).toHaveScreenshot("dashboard-pro.png");
      });
    });
  });
  ...
  test.describe("Suppliers Page", () => {
    test("desktop", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage).toHaveScreenshot("suppliers-desktop.png");
    });
  });
  ...
  test.describe("Prices Page", () => {
    test("desktop", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage).toHaveScreenshot("prices-desktop.png");
    });
  });
  ...
  test.describe("Settings Page", () => {
    test("desktop", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage).toHaveScreenshot("settings-desktop.png");
    });
  });
