...
test.describe("Auth Pages - Load Successfully", () => {
  ...
  test(
    "/auth/login loads without errors",
    { tag: ["@smoke"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/auth/signup loads without errors",
    { tag: ["@smoke"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/auth/forgot-password loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/auth/reset-password loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/auth/verify-email loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
...
test.describe("Protected Pages - Load Successfully", () => {
  ...
  test(
    "/suppliers loads without errors",
    { tag: ["@smoke"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/connections loads without errors",
    { tag: ["@smoke"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
  ...
  test(
    "/propane loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
        await page.goto("/propane", {
          waitUntil: "domcontentloaded",
          timeout: 15000,
        });
      });
  ...
  test(
    "/gas-rates loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
        await page.goto("/gas-rates", {
          waitUntil: "domcontentloaded",
          timeout: 15000,
        });
      });
  ...
  test(
    "/heating-oil loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
        await page.goto("/heating-oil", {
          waitUntil: "domcontentloaded",
          timeout: 15000,
        });
      });
  ...
  test(
    "/community-solar loads without errors",
    { tag: ["@regression"] },
    async ({ page }) => {
      const errors = await collectConsoleErrors(page, async () => {
        await page.goto("/community-solar", {
          waitUntil: "domcontentloaded",
          timeout: 15000,
        });
      });
...
test.describe("No Redirect Loops", () => {
  test(
    "unauthenticated user on / does not loop",
    { tag: ["@regression"] },
    async ({ page }) => {
      await mockBetterAuth(page);
      await clearAuthState(page);
      ...
      const url = page.url();
      expect(
        url.endsWith("/") || url.endsWith(":3000") || url.endsWith(":3000/"),
      ).toBeTruthy();
  ...
  test(
    "authenticated user does not loop between auth and dashboard",
    { tag: ["@regression"] },
    async ({ page }) => {
      await mockBetterAuth(page);
      await setAuthenticatedState(page);
      ...
      // Wait for heading to confirm no redirect loop occurred
      await expect(
        page.getByRole("heading", { name: "Dashboard" }),
      ).toBeVisible({ timeout: 10000 });
  ...
  test(
    "stale session does not cause infinite redirect",
    { tag: ["@regression"] },
    async ({ page }) => {
      ...
      // Wait for any redirect to complete — URL resolves to login or dashboard
...
test.describe("Page Refresh Stability", () => {
  ...
  test(
    "dashboard survives multiple rapid refreshes",
    { tag: ["@regression"] },
    async ({ page }) => {
      await page.goto("/dashboard", {
        waitUntil: "domcontentloaded",
      ...
      // Refresh 3 times — wait for heading after each reload to confirm stability
      for (let i = 0; i < 3; i++) {
  ...
  test(
    "settings page survives refresh",
    { tag: ["@regression"] },
    async ({ page }) => {
      await page.goto("/settings", {
        waitUntil: "domcontentloaded",
...
test.describe("Cross-Page Navigation", () => {
  ...
  test(
    "can navigate between all sidebar pages",
    { tag: ["@smoke"] },
    async ({ page, isMobile }) => {
      ...
      await sidebar
        .getByRole("link", { name: "Optimize", exact: true })
        .click();
...
test.describe("Error Recovery", () => {
  ...
  test(
    "dashboard shows error state when all APIs fail",
    { tag: ["@regression"] },
    async ({ page }) => {
  ...
  test(
    "pages recover after transient API failure",
    { tag: ["@regression"] },
    async ({ page }) => {
      let callCount = 0;
      await page.route("**/api/v1/prices/current**", async (route) => {
