...
import { Zap, Send, Square, RotateCcw, AlertCircle, Bot, User } from 'lucide-react'
    ...
    <div className="flex h-full flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">RateShift AI</h2>
        ...
        {messages.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 max-w-sm text-sm text-gray-500">
              Ask about rates, savings, usage optimization, or have me send reports
