...
// Mock useAuth hook — all mutable state is managed via a shared object that is
// reset in beforeEach to prevent cross-test pollution (16-P3-6).
...
describe("LoginForm", () => {
  beforeEach(() => {
    jest.clearAllMocks();
    // Reset mutable auth state each test to prevent bleed (16-P3-6)
  ...
  it("does NOT show success screen when magic link fails", async () => {
    mockSendMagicLink.mockRejectedValueOnce(
