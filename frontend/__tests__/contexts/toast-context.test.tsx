...
describe('toast() method', () => {
  ...
  it('adds a toast with optional description', () => {
    ...
    expect(screen.getByText('A new version has been released.')).toBeInTheDocument()
  })
  ...
  it('respects a custom duration', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'info', title: 'Short toast', duration: 1000 })
    })
  ...
  it('does not auto-dismiss when duration is 0', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'warning', title: 'Sticky toast', duration: 0 })
    })
  ...
  it('removes only the timed-out toast from a stack', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'success', title: 'Keep me', duration: 0 })
      result.current.toast({ variant: 'error', title: 'Remove me', duration: 1000 })
    })
  ...
  it('each toast gets a unique id', () => {
    ...
    act(() => {
      ...
      result.current.toast({ variant: 'success', title: 'Second', duration: 0 })
    })
...
describe('convenience toast methods', () => {
  ...
  it('success() accepts an optional description', () => {
    ...
    expect(screen.getByText('Your settings have been applied.')).toBeInTheDocument()
  })
...
describe('manual toast dismissal', () => {
  ...
  it('removes the toast when the dismiss button is clicked', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'info', title: 'Click to dismiss', duration: 0 })
    })
  ...
  it('clears the auto-dismiss timer when toast is manually dismissed', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'success', title: 'Dismiss early', duration: 5000 })
    })
...
describe('ToastProvider cleanup on unmount', () => {
  it('clears pending timers when the provider unmounts', () => {
    ...
    act(() => {
      result.current.toast({ variant: 'info', title: 'Pending', duration: 5000 })
    })
