...
import SignupPage from '@/app/(app)/auth/signup/page'
...
describe('SignupPage', () => {
  ...
  it('renders the create account subtitle', () => {
    expect(screen.getByText(/create your account to start saving/i)).toBeInTheDocument()
  })
  ...
  it('renders within a centered layout container', () => {
    const container = screen.getByTestId('signup-form').closest('div.min-h-screen')
