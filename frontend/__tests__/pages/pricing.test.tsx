...
describe('PricingPage', () => {
  ...
  it('renders free tier features', () => {
    expect(screen.getByText('Real-time electricity prices')).toBeInTheDocument()
  ...
  it('renders pro tier features', () => {
    ...
    expect(screen.getByText('Savings tracker & gamification')).toBeInTheDocument()
  })
  ...
  it('renders CTA links with correct hrefs', () => {
    const getStartedFree = screen.getByRole('link', { name: /get started free/i })
  ...
  it('renders FAQ questions', () => {
    ...
    expect(screen.getByText(/where does the price data come from\?/i)).toBeInTheDocument()
  })
