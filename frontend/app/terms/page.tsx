      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray mt-8 max-w-none">
          ...
          <p className="mt-3 text-gray-600">
            ...
            attempting to circumvent rate limits, scraping data, reverse
            engineering the ML models, or using the service for any illegal
            purpose.
          </p>
          ...
          <p className="mt-3 text-gray-600">
            ...
            confidential and must not be shared. We reserve the right to revoke
            API access for misuse.
          </p>
          ...
          <p className="mt-3 text-gray-600">
            ...
            consequential damages arising from use of the service, including any
            financial decisions made based on our data or recommendations.
          </p>
