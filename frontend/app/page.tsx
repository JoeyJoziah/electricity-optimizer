...
const features = [
  ...
  },
  {
    ...
    description:
      "Get notified when rates drop below your threshold so you never miss a savings opportunity.",
  },
  {
    icon: BarChart3,
    title: "ML-Powered Forecasts",
    description:
      "Our machine learning models predict price movements 24 hours ahead with high accuracy.",
  },
  {
    icon: Clock,
    title: "Schedule Optimization",
    description:
      "Automatically schedule high-energy tasks during off-peak hours to maximize savings.",
  },
  {
    icon: Shield,
    title: "GDPR Compliant",
    description:
      "Your data is protected with enterprise-grade security and full regulatory compliance.",
  },
  {
    icon: Zap,
    title: "Weather-Aware",
    description:
      "Weather data integration improves forecast accuracy and helps plan energy usage.",
  },
];
      ...
      <nav className="border-b border-gray-100">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/auth/signup"
              className="rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary-700"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="px-4 pb-16 pt-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <Link
              href="/auth/signup"
              className="rounded-lg bg-primary-600 px-6 py-3 text-base font-medium text-primary-foreground shadow-sm hover:bg-primary-700"
            >
              Start Saving Today
            </Link>
            <Link
