...
class Settings(BaseSettings):
    ...
    @classmethod
    def validate_field_encryption_key(cls, v: str | None) -> str | None:
    ...
    def validate_jwt_secret(cls, v: str) -> str:
        ...
        In production and staging, JWT_SECRET MUST be explicitly set as an
        environment variable.  Auto-generated ephemeral keys are only
        acceptable in development/test to avoid session instability.
        """
        ...
        if env in ("production", "staging") and not jwt_from_env:
            raise ValueError(
                "CRITICAL: JWT_SECRET env var is absent. "
    ...
    @classmethod
    def validate_better_auth_secret(cls, v: str | None) -> str | None:
    ...
    @classmethod
    def validate_stripe_secret_key(cls, v: str | None) -> str | None:
