...
class TestCheckDuplicate:
    ...
    def test_exact_duplicate_detected(self):
        ...
        assert (
            DataQualityService.check_duplicate(existing, 0.12, "us_ny", "electricity")
            is True
        )
    ...
    def test_near_duplicate_within_tolerance(self):
        existing = [{"region": "us_ny", "utility_type": "electricity", "rate": 0.12}]
        assert (
            DataQualityService.check_duplicate(
    ...
    def test_different_rate_not_duplicate(self):
        existing = [{"region": "us_ny", "utility_type": "electricity", "rate": 0.12}]
        assert (
            DataQualityService.check_duplicate(existing, 0.15, "us_ny", "electricity")
            is False
        )
    ...
    def test_different_region_not_duplicate(self):
        existing = [{"region": "us_ny", "utility_type": "electricity", "rate": 0.12}]
        assert (
            DataQualityService.check_duplicate(existing, 0.12, "us_tx", "electricity")
            is False
        )
    ...
    def test_different_utility_type_not_duplicate(self):
        existing = [{"region": "us_ny", "utility_type": "electricity", "rate": 0.12}]
        assert (
            DataQualityService.check_duplicate(existing, 0.12, "us_ny", "natural_gas")
            is False
        )

    def test_empty_existing_not_duplicate(self):
        assert (
            DataQualityService.check_duplicate([], 0.12, "us_ny", "electricity")
            is False
        )
