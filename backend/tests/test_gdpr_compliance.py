...
class TestGDPRComplianceService:
    ...
    def gdpr_service(self, mock_consent_repository, mock_user_repository):
        ...
        return GDPRComplianceService(
            consent_repository=mock_consent_repository, user_repository=mock_user_repository
        )
    ...
    @pytest.mark.asyncio
    async def test_delete_user_data_deletes_all_data(
        self, gdpr_service, mock_consent_repository, mock_user_repository
    ):
    ...
    async def test_delete_user_data_anonymizes_retained_data(self, gdpr_service):
        ...
        await gdpr_service.delete_user_data("user-123", anonymize_retained=True)
...
class TestConsentRepository:
    ...
    async def test_get_latest_consent_by_purpose(self, consent_repository, mock_db_session):
        ...
        await consent_repository.get_latest_by_user_and_purpose("user-123", "marketing")
