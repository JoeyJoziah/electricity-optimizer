...
class TestCreateDirectConnection:
    ...
    def test_create_direct_connection_success(self, client):
        ...
        with patch("utils.encryption.encrypt_field", return_value=b"encrypted"), patch(
            "utils.encryption.mask_account_number", return_value="******5678"
        ):
    ...
    def test_create_direct_connection_duplicate_check(self, client):
        ...
        with patch("utils.encryption.encrypt_field", return_value=b"encrypted"), patch(
            "utils.encryption.mask_account_number", return_value="******1234"
        ):
            response = client.post(
                f"{BASE}/direct",
                json={
    ...
    def test_create_direct_connection_stores_encrypted(self, client):
        ...
        with patch("utils.encryption.encrypt_field") as mock_encrypt, patch(
            "utils.encryption.mask_account_number", return_value="******9999"
        ):
