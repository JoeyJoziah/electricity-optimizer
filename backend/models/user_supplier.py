...
class LinkAccountRequest(BaseModel):
    ...
    service_zip: str | None = Field(default=None, max_length=10)
    account_nickname: str | None = Field(default=None, max_length=100)
    consent_given: bool
    ...
    @classmethod
    def validate_meter_number(cls, v: str | None) -> str | None:
