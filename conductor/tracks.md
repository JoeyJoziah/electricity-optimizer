...
| [~] | ci-ml-tensorflow-py312_20260515 | CI ML Tests — install fixed (tensorflow 2.17.1 + tf-keras 2.17.0 + tensorboard 2.17.1 pull cp312 wheels, import OK on py3.12.12), but **VALIDATION 2026-05-21 FOUND A RUNTIME REGRESSION**: full ML suite = 30 failed / 694 passed / 4 errors under TF 2.17/Keras 3. CNN-LSTM output shape `[?,24,3]` vs loss `[?,24]` + training-callback drift; `TF_USE_LEGACY_KERAS=1` does NOT fix it. The "awaiting CI green" claim was optimistic — CI would be RED. Needs real Keras-3 migration (activate shim properly OR fix model/loss). NOT a wheel bump. | 2026-05-15 | 2026-05-21 |
