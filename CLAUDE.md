...
- **NeonDBAgent**: 49 public + 9 neon_auth = 58 tables (65 migrations: init_neon through 065_utilityapi_addon_billing), Neon project `cold-rice-23455092`, UUID PKs, migration patterns
...
- **Database**: Neon PostgreSQL — project `cold-rice-23455092` ("energyoptimize"), endpoint `ep-withered-morning` (us-east-1), 49 public + 9 neon_auth = 58 tables total (65 migrations: init_neon through 065_utilityapi_addon_billing)
