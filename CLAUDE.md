...
> Last validated: 2026-03-16 (Codebase audit remediation complete, full docs refresh. Backend 2,536 tests, Frontend 1,898 tests (138 suites). 50 migrations (050: community_posts_indexes). 53 tables (44 public + 9 neon_auth). 15 sidebar nav items. 32 GHA workflows. DSP graph: 474 entities (436 source + 38 external), 934 imports, 1 real cycle — rebuilt clean from scratch. All active docs verified against filesystem.)
