...
> Current State: 1,374 backend tests (pass), 1,401 frontend tests (pass), 611 ML tests (pass), 55 ML tests (skipped), 16 E2E spec files
...
| Frontend | 1,401 | 0 | 0 | 75%+ |
| ML | 611 | 0 | 55 | 80%+ |
| E2E | 634 | 0 | 5 | 95%+ |
| **Total** | **3,386+** | **0** | **60** | **80%+ overall** |
